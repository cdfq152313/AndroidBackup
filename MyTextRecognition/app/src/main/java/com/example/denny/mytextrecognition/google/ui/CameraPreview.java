...
public class CameraPreview extends FrameLayout {
    ...
    public void initialize() {
        ...
        mTextRecognizer = createTextRecognizer();
    }
    ...
    public void setListener(TextTracker.Listener listener){
        TextTracker tracker = new TextTracker(listener);
        mTextRecognizer.setProcessor(new MultiProcessor.Builder<>(tracker).build());
    }
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        Log.i(TAG, "OnLayout");
        if(mCameraSource == null){
            mCameraSource = createCameraSource(right-left, bottom-top, true, mTextRecognizer);
            resume();
        }
    }
    ...
    CameraSource createCameraSource(int width, int height, boolean autoFocus, TextRecognizer detector){
        Context context = getContext().getApplicationContext();
