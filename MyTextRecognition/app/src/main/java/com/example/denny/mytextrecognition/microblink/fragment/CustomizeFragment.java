 ...
 */
public class CustomizeFragment extends Fragment implements ScanResultListener, CameraEventsListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mRecognizerView = new RecognizerView(getActivity());
        ...
        if(!RecognizerCompatibility.cameraHasAutofocus(CameraType.CAMERA_BACKFACE, getActivity().getApplicationContext())) {
