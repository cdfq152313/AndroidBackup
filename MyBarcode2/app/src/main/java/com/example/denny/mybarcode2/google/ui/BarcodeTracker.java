...
public class BarcodeTracker extends Tracker<Barcode> implements MultiProcessor.Factory<Barcode>{
    Listener trackerListener;

    BarcodeTracker(Listener trackerListener) {
    ...
    public void onNewItem(int id, Barcode item) {
        trackerListener.onUpdate(String.format("%d: %s",count, item.rawValue));
    }
